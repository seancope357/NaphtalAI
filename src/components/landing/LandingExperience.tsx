  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background text-foreground">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(1200px_620px_at_10%_-20%,rgba(59,130,246,0.16),transparent_60%),radial-gradient(1000px_580px_at_100%_0%,rgba(14,165,233,0.12),transparent_62%)]" />
      ...
      <main className="relative mx-auto max-w-7xl px-4 pb-20 pt-12 md:px-8 md:pt-14">
        <section className="grid gap-10 md:grid-cols-2 md:items-center">
          <div>
            <p className="mb-4 inline-flex items-center gap-2 rounded-full border border-primary/25 bg-primary/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-primary">
              Research Intelligence Platform
            </p>
            <h1 className="max-w-[16ch] text-4xl font-semibold leading-tight tracking-tight text-balance md:text-5xl">
              Modern intelligence workbench for evidence-driven research
            </h1>
            <p className="mt-5 max-w-[52ch] text-sm text-muted-foreground md:text-base">
          ...
          <div className="rounded-2xl border border-border/70 bg-card/75 p-4 shadow-2xl backdrop-blur-sm md:p-5">
            ...
            <div className="grid gap-3">
              <div className="rounded-lg border border-border bg-background p-3">
                ...
                <div className="h-24 rounded-md border border-border/70 bg-muted/20" />
              </div>
        ...
        <section className="mt-20">
          <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">Core capabilities</h2>
          <p className="mt-2 max-w-[60ch] text-sm text-muted-foreground md:text-base">
            Built for researchers who need speed, structure, and a UI that stays out of the way.
          </p>
        ...
        <section className="mt-20 rounded-2xl border border-border/70 bg-card/70 p-6 text-center shadow-xl md:p-8">
